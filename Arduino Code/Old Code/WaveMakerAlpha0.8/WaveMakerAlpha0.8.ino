...
currentSpeed = abs(ceil(LRC*((6*amplitude_step)/period)));                                                                                             //Initializing a variable for recursive speed calibration
currentAccel = abs(ceil(LRC*((18*amplitude_step)/(ratio*(period*period)))));  
